...
import com.likeorz.models.{ Feedback, Installation }
...
trait FeedbackComponent { self: HasDatabaseConfig[JdbcProfile] =>
  ...
  protected val feedback = TableQuery[FeedbackTable]
}
...
trait InstallationComponent { self: HasDatabaseConfig[JdbcProfile] =>
  ...
  protected val installations = TableQuery[InstallationTable]
}
