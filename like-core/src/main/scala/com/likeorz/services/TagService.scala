...
import com.likeorz.models.{ UserTag, TagGroup, User, Tag, UserInfo }
...
trait TagService {
  ...
  def hotUsersForTag(tag: String, num: Int): Future[Seq[UserInfo]]
  ...
  def getUserHistoryTagIds(userId: Long): Future[Seq[Long]]
